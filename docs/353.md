...
```
<code="language-python"># Read in the dataimport pandas as pd
...
print(fcc.shape)
pd.options.display.max_columns = 150 # to avoid truncated output fcc.head()</code="language-python">
```
...
only_4 = only_4.drop(less_than_3_months.index)</code="language-python">
```
...
canada_outliers</code="language-python">
```
...
only_4 = only_4.drop(canada_outliers.index)</code="language-python">
```
...
<code="language-python">
# Recompute mean sum of money spent by students each month
only_4.groupby('CountryLive').mean()['money_per_month']</code="language-python">
```
...
![Stats2_39_0](../Images/e91e0b6909899758af792a76b4977640.png)
...
only_4['CountryLive'].value_counts(normalize = True) * 100</code="language-python">
```
