...
> 原文:[https://www.dataquest.io/blog/last-fm-api-python/](https://www.dataquest.io/blog/last-fm-api-python/)

October 7, 2019![](../Images/770437b1a2fb0c743283c08ca37ceb3e.png)
...
![Create an API account](../Images/275b1e9ab363044fbe643102d6c0f12b.png)

在每个字段中填写您计划如何使用 API 的信息。您可以将“回调 URL”字段留空，因为这仅在您构建 web 应用程序以作为特定 Last.fm 用户进行身份验证时使用。

提交表单后，您将获得 API 密钥和共享密钥的详细信息:

![Last.fm API keys](../Images/8dc8c38acd906407503c85a4813fa917.png)
...
![API Rate limiting workflow](../Images/2e09a1b742fab0e6485f585e19fc5cb8.png)
...
![Converting a list of lists into a pandas dataframe](../Images/deeb7208c7303f0c00fcd63591454783.png)
