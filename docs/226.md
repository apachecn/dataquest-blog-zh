...
R 有一个欣欣向荣的软件包生态系统，为核心 R 语言增加了功能。这些包由 [<u>CRAN</u>](https://cran.r-project.org/) 分发，可以使用 R 语法下载(与使用单独包管理器的 Python 相反)。我们下面列出的包是 r 中一些最常用和最流行的数据科学包。
...
![best-free-tools-for-data-science-tidyverse](img/f6696efa00afc1cec69a9c59cbce9a11.png "best-free-tools-for-data-science-tidyverse")T3】
...
![r-markdown-notebook-demo](img/4a0debe6598b09b795acded5a86841a6.png "r-markdown-notebook-demo")T2】
...
![scikit-learn-plots best free data science tools](img/4acc91d41a4fa9ada7c35d07b3957c25.png "scikit-learn-plots")T2】
...
![jupyter-notebook best free data science tools](img/e703b9aa2ab39dc5af38fb60e5958288.png "jupyter-notebooks-tutorial")T2】
