...
> 原文：[DataQuest Blog](https://www.dataquest.io/blog/)
> 
...
*   在我们的 [apachecn/dataquest-blog-zh](https://github.com/apachecn/dataquest-blog-zh) github 上提 issue.
...
```
docker pull apachecn0/dataquest-blog-zh
docker run -tid -p <port>:80 apachecn0/dataquest-blog-zh
...
```
pip install dataquest-blog-zh
dataquest-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g dataquest-blog-zh
dataquest-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
